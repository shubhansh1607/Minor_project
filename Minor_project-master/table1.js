...
app.post("/", (req, res) => {
  const co1t1 = req.body.txtCo1Test1;
  const co1t2 = req.body.txtCo1Test2;
  const co1t3 = req.body.txtCo1Test3;
  const co1assignment = req.body.txtCo1Assignment;
  const co1gp = req.body.txtCo1GroupPresentation;
  const co1end = req.body.txtCo1EndSemMarks;
  var x1 =
  ...
  connection.connect((err) => {
    if (err) {
      ...
      var sql="INSERT INTO directassesment VALUES('"+x1+"','"+x2+"','"+x3+"','"+x4+"','"+x5+"','"+x6+"')";
